...
home = os.getcwd()
train_file = os.path.join(home, "datasets", "corpus", "train.json")
dev_file = os.path.join(home, "datasets", "corpus", "dev.json")
test_file = os.path.join(home, "datasets", "corpus", "test.json")
glove_word_file = os.path.join(
    home, "datasets", "emb", "Total_word.word")
...
flags.DEFINE_integer("glove_char_size", 14082, "Corpus size for Glove")
flags.DEFINE_integer("glove_word_size", int(1292607), "Corpus size for Glove")
